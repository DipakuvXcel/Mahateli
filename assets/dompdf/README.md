...
The have been pre-installed to give dompdf decent Unicode character coverage by default. To use the DejaVu fonts reference the font in your stylesheet, e.g. `body { ffont-family: Verdana, Arial, Helvetica, sans-serif; }` (for  Verdana, Arial, Helvetica, sans-serif).
