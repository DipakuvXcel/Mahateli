			...
			<div class="row">
				<div class="col-md-8 col-lg-9">
						...
						<div class="item-blog p-b-80">
							<a href="<?php echo base_url('frontend/blog_details/'.$blogs[$i]->id); ?>" class="item-blog-img pos-relative dis-block hov-img-zoom">
							...
							<div class="item-blog-txt p-t-33">
								<h4 class="p-b-11">
									<a href="<?php echo base_url('frontend/blog_details/'.$blogs[$i]->id); ?>" class="m-text24">
										<?= $blogs[$i]->title;?>
									</a>
								</h4>
								...
								<a href="<?php echo base_url('frontend/blog_details/'.$blogs[$i]->id); ?>" class="s-text20">
									Continue Reading
