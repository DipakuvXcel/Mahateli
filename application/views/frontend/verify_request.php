		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-md-4 col-lg-4 p-b-50  text-center">
				 	<div class="formd" >
						<form id="registration_form" action="<?php echo base_url('frontend/request_otp_verify');?>"  method="post" autocomplete="off">
							<h3>Verify Request</h3>
							<p class="p-t-10">Verify your request by otp</p>
