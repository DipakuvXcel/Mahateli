...
.table-responsive{
	...
	<div class="bread-crumb bgwhite flex-w p-l-52 p-r-15 p-t-30 p-l-15-sm">
		...
		<a href="<?php echo base_url('profile'); ?>" class="s-text16"> My Profile
		<i class="fa fa-angle-right m-l-8 m-r-9" aria-hidden="true"></i>
		</a>
		<span class="s-text17"> My Orders </span>
	</div>
									...
									<tr class="odd gradeX" <?php if(in_array($order[$i]->order_status,$arrstc)){?> style="background: #f7c0c0 !important;" <?php } else if(in_array($order[$i]->order_status,$arrstd)){ ?> style="background: indianred !important;" <?php } ?>>
										...
										<td>
											...
											<?php if($order[$i]->order_invoice){ ?>
												<a href="<?= upload_path.'order_invoice/'.$order[$i]->order_invoice; ?>" download><i class="fa fa-download"></i> Download</a>
											<?php } else { ?> 
												<a href="<?= upload_path.'order_document/'.$order[$i]->document; ?>" download><i class="fa fa-download"></i> Download</a>
											<?php } ?> 
