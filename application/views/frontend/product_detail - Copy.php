...
.persent2{
    ...
    <!--================Home Banner Area =================-->
    <!-- breadcrumb -->
	<div class="bread-crumb bgwhite flex-w p-l-52 p-r-15 p-t-0 p-l-15-sm">
				...
				<div class="wrap-slick3 flex-sb flex-w">
					...
					<div class="slick3">
					 <?php //echo $_SESSION['guest_user_profile']->id."hi--------------";
						...
						?>
						<div class="item-slick3" data-thumb="<?php echo upload_path.'product_profile/'.$products->image;?>" data-zoom-image="<?php echo upload_path.'product_profile/'.$products->image;?>">
							<?php 
								...
								if($products->product_type==1)
									...
									<img style="width: 33%; position: absolute; right: 0px;"src="<?php echo upload_path.'1stInIndia.png';?>" alt="IMG-PRODUCT">
						
								<?php } ?>
							
							<div class="wrap-pic-w1">
								<img  id="img"  src="<?php echo upload_path.'product_profile/'.$products->image;?>" alt="IMG-PRODUCT">
							</div>
						</div>
				   <?php 
					$table = 'rating';
