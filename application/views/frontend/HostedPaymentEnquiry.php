	...
	?>
		...
		<center>
			<table width="100%" height="100%" cellpadding="1" cellspacing="1">
				<tr>
					<td>
						<form name="form1" ACTION="http://localhost/myfuel/phpbob/tranportalhttp/TranPipeBuyHttp.php" METHOD="POST">
										...
										<div class="container">
											...
											<div class="col-md-12">  
												...
												<div class="m-b-20 text-center">
													<h5 class="m-b-20">Transaction Id = <span style="color:green;"> #<?php echo (empty($track_id)) ? '' : $track_id ?></span></h5>
												</div>
												<br>
