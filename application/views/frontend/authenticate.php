		...
		<div class="container" style="border: 1px solid silver;margin-bottom: 5%;">
			<div class="row">
				...
				<div class="bgwhite hov-img-zoom pos-relative p-b-20per-ssm"  >
					...
					<h3 class="m-t-20 t-center">IS YOUR PROTEIN ORIGINAL ?<hr></h3>
				
					<div class="text-center">
						<p class="s-text2">Know is your MyFuel product is authentic. </p>
						<p class="m-b-30">Look for the Unique code under the cap </p>
						...
						<form class=" " autocomplete="off" method="post" id=" " novalidate="novalidate" action="<?php echo base_url('frontend/check_authentication') ?>" >
							...
							<div class="col-md-6" >
								<img src="<?php echo assets_path; ?>img/myFuelA1.png" alt="IMG-BANNER" />
							</div>
							...
							<div class="col-md-4 text-left" >
								...
								<label class="text-left m-b-10">Enter Unique Code</label>
