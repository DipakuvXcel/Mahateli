...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo base_url("site/send_password_recovery_link");?>" method="post">
                ...
                <div class="form-actions">
                    <button type="submit" class="btn blue uppercase">Send</button>
                    <a class="btn green uppercase" href="<?php echo base_url(); ?>">Back</a>
                </div>
            </form>
            <!-- END LOGIN FORM -->
