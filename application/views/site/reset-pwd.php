...
<!-- end loader -->
    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo base_url("site/update_reset_password");?>" method="post">
                ...
                <div class="form-actions">
                    <button type="submit" class="btn dark_gray_bt uppercase" style="background:#000;color:#fff;">Reset</button>
                </div>
