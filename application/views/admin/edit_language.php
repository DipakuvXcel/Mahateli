	...
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li><a href="<?php echo base_url('admin/add_city'); ?>">Mother tongue</a>
					<i class="fa fa-angle-right"></i></li>
				<li><span> Edit Mother tongue</span>	
			</ul>
		</div>
		<!-- END PAGE HEADER-->
			...
			<div class="col-md-12">
				...
				<div class="portlet light ">
					<div class="portlet-title">
						<div class="caption font-dark">
							<i class="icon-settings font-dark"></i> <span
								class="caption-subject bold uppercase"> Edit Mother tongue</span>
						</div>
						<div class="actions">
					...
					<div class="portlet-body">
						...
						<form id="add_student_form" class="horizontal-form" action="<?php echo base_url('admin/update_edit_language');?>" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											<input id="language_name" name="language_name" class="form-control" type="text" value="<?= set_value('language', $language->language_name); ?>">
										</div>
									</div>
