				...
				<div class="tab-pane fade p-3 active in" id="one" role="tabpanel" aria-labelledby="one-tab">
					<div class="col-md-12">
						...
						<div class="portlet light ">
                    		...
                    		<a href="<?php echo base_url('admin/add_users');?>" class="btn btn-transparent green-meadow btn-outline btn-circle btn-sm active fa fa-plus">Add Users</a>
						</div>
					</div>
								...
								<tr class="odd gradeX">
									...
									<td>
										<?php if($user[$i]->status_id == 1) { ?>
											<a  href="<?= base_url('admin/update_user_status/2/'.$user[$i]->id); ?>" class="btn default btn-xs yellow-gold-stripe" onclick="if(!confirm('Are you sure to make inactive?')) return false;"> Inactive </a>
										<?php } else if($user[$i]->status_id == 2) { ?>
											<a  href="<?= base_url('admin/update_user_status/1/'.$user[$i]->id); ?>" class="btn default btn-xs green-meadow-stripe" onclick="if(!confirm('Are you sure to make active?')) return false;"> Active </a>
										<?php } else if($user[$i]->status_id == 3) { ?>
											<a  href="<?= base_url('admin/update_user_status/1/'.$user[$i]->id); ?>" class="btn default btn-xs green-meadow-stripe" onclick="if(!confirm('Are you sure to make active?')) return false;"> Verifiy </a>
										<?php } ?>
										
											<a style=""  href="<?= base_url('admin/user_details/'.$user[$i]->id); ?>" class="btn default btn-xs green-stripe">View Details </a>
											<a style=""  href="<?= base_url('admin/edit_users/'.$user[$i]->id); ?>" class="btn default btn-xs yellow-gold-stripe">Edit </a>
											<a style=""  href="<?= base_url('admin/user_family_details/'.$user[$i]->id); ?>" class="btn default btn-xs green-stripe">Family Details </a>
											...
											<a  href="<?php echo base_url('admin/update_user_status/0/'.$user[$i]->id) ;?>" class="btn default btn-xs red-soft-stripe" onclick="if(!confirm('Are you sure to delete ? Dealer will be deleted permanently.')) return false;">Delete </a>
									</td>
