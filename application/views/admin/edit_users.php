			...
			<div class="col-md-12">
				...
				<div class="portlet light ">
					<div class="portlet-title">
						<div class="caption font-dark">
							<i class="icon-settings font-dark"></i> <span
								class="caption-subject bold uppercase">  Edit user</span>
						</div>
						<div class="actions">
					...
					<div class="portlet-body">
						...
						<form id="add_student_form" class="horizontal-form" action="<?php echo base_url('admin/update_user');?>"
							...
							<h4 style="background-color:#68838B;color:#fff;padding:10px;">Personal Details</h4>
								...
								<div class="col-md-3 col-md-push-1">
									<div class="form-group">
											...
											<input id="start_time" name="contact" class="form-control" type="number" required value="<?= set_value('contact',$user->contact); ?>">
										</div>
									</div>
									<div class="col-md-3 col-md-push-1">
										<div class="form-group">
											<label class="control-label">Email / Username</label><span style="color:red">*</span>
											<input id="end_time" name="email" class="form-control" readonly type="Email" value="<?= set_value('email',$user->email); ?>">
										</div>
									</div>
									<div class="col-md-3 col-md-push-1">
										<div class="form-group">
