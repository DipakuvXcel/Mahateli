	...
	<div class="page-content">
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				...
				<li><a href="<?php echo base_url('admin/admin_user'); ?>">Admin User</a> </li> <i class="fa fa-angle-right"></i>
				<li><a> Add user</a> </li>
				<li><span></span>	
			</ul>
		</div>
			...
			<div class="col-md-12">
				...
				<div class="portlet light ">
					<div class="portlet-title">
						<div class="caption font-dark">
							<i class="icon-settings font-dark"></i> <span
								class="caption-subject bold uppercase "> Add Admin User</span>
						</div>
						<div class="actions">
								<a href="<?php echo base_url('admin/admin_user');?>" class="btn btn-circle default fa fa-arrow-left">Back
								</a>
						</div>
					</div>
			        ...
			        <div class="Metronic-alerts alert alert-danger fade in">
						...
						<form id="add_student_form" class="horizontal-form" autocomplete="off" action="<?php echo base_url('admin/save_admin_user');?>"  method="post" enctype="multipart/form-data" autocomplete="Off">
							<div class="form-body">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<?php for($m=0;$m<count($caste);$m++){ ?>
                                                <option value="<?= $caste[$m]->id ?>" > <?php echo $caste[$m]->caste_name; ?></option>
                                            <?php } ?>
											</select>
											<div class="select_arrow"></div>
										</div>
