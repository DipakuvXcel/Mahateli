        ...
        <div class="content">
            ...
            <form class="login-form" action="<?php echo base_url('admin/do_login');?>" method="post">
                ...
                <div class="form-group">
                    ...
                    placeholder="Email" name="email_id" value="<?php echo set_value('email_id');?>" /> </div>
                <div class="form-group">
                ...
                <div class="form-actions">
                   ...
                   <a href="<?php echo base_url("admin/forgot_password");?>" class="forget-password">Forgot Password?</a> 
                </div>
