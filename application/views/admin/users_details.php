						...
						<input type="hidden" name="id" value="<?= $user->id; ?>">
							<div class="form-body">
								...
								<div class="row">
									...
									<label><span>Profile : <br></span><img alt=""style="width:200px;height:250px;" src="<?php echo upload_path; ?>/profile/<?=$user->image;?>" /></label><br>
								</div>
								...
								<div class="row">
									<div class="col-md-4 col-md-push-1">
										<div class="form-group">
											<label class="control-label bold">Landmark : </label> <?= $reside->landmark; ?>
										</div>
									</div>
									<div class="col-md-1"></div>
									<div class="col-md-4">
								...
								<div class="row">
									<div class="col-md-4 col-md-push-1">
										<div class="form-group">
											<label class="control-label bold">Landmark : </label> <?= $corrs->landmark; ?>
										</div>
									</div>
									<div class="col-md-1"></div>
									<div class="col-md-4">
