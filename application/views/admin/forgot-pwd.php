...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            ...
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo base_url("admin/send_password_recovery_link");?>" method="post">
                <h3 class="form-title font-dark" style="color:#000;">Forgot Your Password?</h3>
